...
public class BruteForcerData {
    ...
    public boolean containsUsersNumber(Integer users) {
        return  usersBase.containsKey(users);
    }

    public boolean containsProvidersNumber(Integer providers) {
        return providersBase.containsKey(providers);
    }
}
